...
function RenderSprite(TextureDictionary, TextureName, X, Y, Width, Height, Heading, R, G, B, A)
    ...
    DrawSprite(TextureDictionary, TextureName, X + Width * 0.5, Y + Height * 0.5, Width, Height, Heading or 100, tonumber(R) or 255, tonumber(G) or 255, tonumber(B) or 255, tonumber(A) or 125)
end