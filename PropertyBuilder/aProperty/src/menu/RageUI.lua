...
RageUI.Settings = {
    ...
    Items = {
        Title = {
            ...
            Text = { X = 215, Y = 20, Scale = 1.20 },
        },
        Subtitle = {
            Background = { Width = 431, Height = 0 },
            Text = { X = 10, Y = -104, Scale = 0.50 },
            PreText = { X = 425, Y = -100, Scale = 0.35 },
        },
        Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 0, Width = 431 },
        Navigation = {
            Rectangle = { Width = 431, Height = 10 },
            Offset = 5,
            Arrows = { Dictionary = "commonmenu", Texture = "shop_arrows_upanddown", X = 190, Y = -3, Width = 25, Height = 25 },
        },
        Description = {
            Bar = { Y = 4, Width = 431, Height = 1 },
    ...
    if RageUI.CurrentMenu ~= nil then
        if RageUI.CurrentMenu() then
            ...
            if RageUI.CurrentMenu.Subtitle ~= "" then
                ...
                RenderText(RageUI.CurrentMenu.Subtitle, RageUI.CurrentMenu.X + RageUI.Settings.Items.Subtitle.Text.X, RageUI.CurrentMenu.Y + RageUI.Settings.Items.Subtitle.Text.Y + RageUI.ItemOffset, 4, RageUI.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUI.Settings.Items.Subtitle.Background.Width + RageUI.CurrentMenu.WidthOffset)
