local Statistics = {
    ...
    Text = {
        Left = { X = -40, Y = 15, Scale = 0.27 },
    },
    Bar = { Right = 8, Y = 27, Width = 200, Height = 7 , OffsetRatio = 0.5 },
    Divider = {
        [1] = { X = 200, Y = 27, Width = 2, Height = 7 },
        [2] = { X = 200, Y = 27, Width = 2, Height = 7 },
        [3] = { X = 200, Y = 27, Width = 2, Height = 7 },
        [4] = { X = 200, Y = 27, Width = 2, Height = 7 },
        [5] = { X = 200, Y = 27, Width = 2, Height = 7 },
    }
}
