...
local SettingsButton = {
    ...
    Text = { X = 8, Y = 3, Scale = 0.27 },
    LeftBadge = { Y = -2, Width = 30, Height = 30 },
    RightBadge = { X = 385, Y = -2, Width = 30, Height = 30 },
    RightText = { X = 420, Y = 4, Scale = 0.30 },
    SelectedSprite = { Dictionary = "commonmenu", Texture = "gradient_nav", Y = 0, Width = 431, Height = 30 },
}
